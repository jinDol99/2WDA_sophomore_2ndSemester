...
ServiceKey = "b2j0lOuzAsVNBkrqXjLU6xECwJ87j8bnhK5PGRAyYn9wab1F0Zo15c5o1%2Fr4Q4TEqcmF9n0Qc0ftrr59Bax%2Big%3D%3D"
    ...
    for year in range(nStartYear, nEndYear+1):
        for month in range(1, 13):
            ...
            if (jsonData['response']['header']['resultMsg'] == 'OK'): 
                #데이터가 없는 마지막 항목인 경우 ----------------------------
                if jsonData['response']['body']['items'] == '': dataEND = "{0}{1:0>2}".format(str(year), str(month-1))
