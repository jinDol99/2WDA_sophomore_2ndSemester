...
<ul>
	...
	<li><a href="./book_r3.jsp?currentPageNo=0&displayRecordCnt=10">조회3(페이징v2, 레코드수선택, R3)</a>
...
<h2>로그인 정보 관리</h2>
<ul>
	<li><a href="./member_r.jsp">회원정보 조회(R)</a>
	<li><a href="./member_u.jsp">회원정보 수정(U)</a>
	<li><a href="./member_d.jsp">회원정보 삭제(D)</a>
</ul>
</body>
</html>